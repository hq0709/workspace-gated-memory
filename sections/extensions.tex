...
scored from the same gradient). The expectation $\mathbb{E}_q$ is taken over a
fixed bank of 12 probe-blind questions per episode, with utility scored on the
model's own greedy answers $\hat a_q$ rather than gold answers; sensitivity to
this bank and to the answer surrogate is not characterized here and is a
limitation.
