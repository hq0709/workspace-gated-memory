...
Evoked & Qwen3-8B & 0.620 & 0.383 & +0.237 [+0.157, +0.314]$^{*}$ & -0.97 \\
...
Decoupled & Qwen3-8B & 0.654 & 0.337 & +0.317 [+0.238, +0.402]$^{*}$ & -1.06 \\
...
Compositional & Qwen3-8B & 0.545 & 0.325 & +0.220 [+0.146, +0.306]$^{*}$ & n/a \\
